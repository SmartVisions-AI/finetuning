...
Qwen 14B Distill version of deepseek trained with GRPO
...
|----------|-------------|-------------|
| `Tourism_Deepseek_R1_Qwen14B__GRPO_Training-500Steps.ipynb` | 500 sample, subset of the 26k Cot Dataset recieved | moslehGen/DeepSeek-R1-Distill-Qwen-14B-500Steps
| 
...
## Reward function is the basic reward function from gsm8k dataset
